  ...
  def historia_clinica_params(step)
    permitted_attributes = case step
       when "a_historia_clinica"
          [:primer_nombre, :second_name, :first_surname, :second_surname, 
          ...
          :paciente_id, :origin, :destination, :company, :accompanist_name, :relationship, :phone, :reason_for_consultation, 
          :current_illness]
       ...
       when "d_examen_fisico"
          ...
          [:ta_mmgh_diastole, :ta_mmgh_sistole , :glucometria, :heart_rate, :breathing_frequency, :sat_of_o_ambiente, 
